...
if (number/24) >= 151
    yr = 2018;
    mon = 3;
    dy = floor(number/24) - 150;
elseif (number/24) >= 123
    yr = 2018;
    mon = 2;
    dy = floor(number/24) - 122;
elseif (number/24) >= 92
    yr = 2018;
    mon = 1;
    dy = floor(number/24) - 91;
elseif (number/24) >= 61
    yr = 2017;
    mon = 12;
    dy = floor(number/24) - 60;
elseif (number/24) >= 31
    yr = 2017;
    mon = 11;
    dy = floor(number/24) - 30;
else
    yr = 2017;
    mon = 10;
    dy = floor(number/24) + 1;
end
...
spa.delta_ut1     = 0;
spa.delta_t       = 67;
spa.longitude     = -111.9217992;
spa.latitude      = 50.5541732;
spa.elevation     = 760;
spa.pressure      = 820;
spa.temperature   = -8;
spa.slope         = 69;
...
if (result == 1)  %check for SPA errors
