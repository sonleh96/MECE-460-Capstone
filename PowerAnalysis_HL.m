...
function PowerAnalysis_HL(filename)

%Input Variable definitions
Q_total = 10.694; %Total airflow [m3/s]
angle = 18; %angle of tilt of solar heater, [deg]
...
for i = 1:(n-1)
    ...
    if (T_ent(i) < T_desired)
        ...
        P_elec(i) = P_fans; %Fans are the source of electricity draw
